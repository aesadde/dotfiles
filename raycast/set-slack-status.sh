...
# @raycast.title Set Slack Status
# @raycast.mode silent

# Optional parameters:
# @raycast.packageName Slack
# @raycast.icon 💬
# @raycast.argument1 { "type": "text", "placeholder": "status string" }
# @raycast.argument2 { "type": "text", "placeholder": "emoji" }
...
then
  ...
  echo "Set status to $STATUS in Slack"
  exit 0
fi
